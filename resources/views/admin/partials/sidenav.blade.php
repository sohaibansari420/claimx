        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.speed') }} ">
                                <a href="{{ route('admin.speed') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Speed')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.tap') }} ">
                                <a href="{{ route('admin.tap') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Tap')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
