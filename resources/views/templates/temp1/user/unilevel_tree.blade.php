...
@section('panel')
    ...
    @php
    // Recursive function to render the unilevel tree with your existing markup
    function renderUnilevelTree($node) {
        if (!$node || !isset($node['user'])) {
            return;
        }
        echo '<div class="mgt-item">';
        ...
        if (!empty($node['children'])) {
            ...
            foreach ($node['children'] as $child) {
                echo '<div class="mgt-item-child">';
                renderUnilevelTree($child);
                echo '</div>';
            }
            echo '</div>';
        }
                            ...
                            <section class="management-tree">
                                <div class="mgt-container">
                                    <div class="mgt-wrapper">
                                        @php renderUnilevelTree($tree); @endphp
                                    </div>
                                </div>
                            </section>
                        </div>
