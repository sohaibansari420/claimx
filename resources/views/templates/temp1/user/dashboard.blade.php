    ...
    <div class="col-xl-8 wow fadeInUp" data-wow-delay="1.6s">
        ...
        <div class="card overflow-hidden">
            <div class="text-center p-3 overlay-box" style="background-image: url({{ asset($activeTemplateTrue) }}/dashboard/images/big/img4.jpg);">
                <h3 class="mt-3 mb-1 text-white">VIP Unilevel Bonus</h3>
                <p class="text-white mb-2">The VIP Unilevel Bonus is a multi-level commission system that rewards members for sales from direct referrals, with unlimited direct recruits and fixed earnings per level.</p>
            </div>
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-12">
                        <p class="mb-0 fs-15">VIP Unilevel Bonus is a performance-based reward system designed to incentivize network expansion by offering commissions on multiple levels of referrals. Unlike single-tier bonuses, it allows members to earn a percentage of sales or token purchases generated by their direct and indirect downlines, typically across five or more levels. The VIP structure offers unlimited width—meaning there is no cap on the number of people you can directly refer—and rewards are distributed according to a fixed percentage plan at each level. This model not only motivates leaders to build and support active teams but also creates sustainable earning potential for participants who focus on both personal recruitment and team development.</p>
                    </div>
